<template>
    <div class="navbar-container">
        ...
        <div class="navbar" :class="{ active: isNavVisible }">
            ...
            <div class="line"></div>
            <div class="items">
                <div class="item" :class="{ selected: isSelected === 'home' }" @click="showItem('home')">
                ...
                <div class="item" :class="{ selected: isSelected === 'charts' }" @click="showItem('charts')">
                ...
                <div class="item" :class="{ selected: isSelected === 'workingtimes' }" @click="showItem('workingtimes')">
                ...
                <div class="item" :class="{ selected: isSelected === 'profile' }" @click="showItem('profile')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="37" viewBox="0 0 32 37" fill="none">
                        <path
                ...
                <div v-if="!isAdmin" class="item" :class="{ selected: isSelected === 'team' }" @click="showItem('team')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="34" viewBox="0 0 45 34" fill="none">
                        <path
                            d="M6.75 14.1807C9.23203 14.1807 11.25 12.061 11.25 9.45378C11.25 6.84661 9.23203 4.72689 6.75 4.72689C4.26797 4.72689 2.25 6.84661 2.25 9.45378C2.25 12.061 4.26797 14.1807 6.75 14.1807ZM38.25 14.1807C40.732 14.1807 42.75 12.061 42.75 9.45378C42.75 6.84661 40.732 4.72689 38.25 4.72689C35.768 4.72689 33.75 6.84661 33.75 9.45378C33.75 12.061 35.768 14.1807 38.25 14.1807ZM40.5 16.5441H36C34.7625 16.5441 33.6445 17.0685 32.8289 17.9179C35.6625 19.5501 37.6734 22.497 38.1094 25.9979H42.75C43.9945 25.9979 45 24.9417 45 23.6345V21.271C45 18.6638 42.982 16.5441 40.5 16.5441ZM22.5 16.5441C26.8523 16.5441 30.375 12.8438 30.375 8.27206C30.375 3.70027 26.8523 0 22.5 0C18.1477 0 14.625 3.70027 14.625 8.27206C14.625 12.8438 18.1477 16.5441 22.5 16.5441ZM27.9 18.9076H27.3164C25.8539 19.6461 24.2297 20.0893 22.5 20.0893C20.7703 20.0893 19.1531 19.6461 17.6836 18.9076H17.1C12.6281 18.9076 9 22.7186 9 27.416V29.5431C9 31.5003 10.5117 33.0882 12.375 33.0882H32.625C34.4883 33.0882 36 31.5003 36 29.5431V27.416C36 22.7186 32.3719 18.9076 27.9 18.9076ZM12.1711 17.9179C11.3555 17.0685 10.2375 16.5441 9 16.5441H4.5C2.01797 16.5441 0 18.6638 0 21.271V23.6345C0 24.9417 1.00547 25.9979 2.25 25.9979H6.88359C7.32656 22.497 9.3375 19.5501 12.1711 17.9179Z"
                            fill="#A4AABD" />
                    </svg>
                    <h2>Team</h2>
                </div>
                <div v-if="isAdmin" class="item" :class="{ selected: isSelected === 'admin' }" @click="showItem('admin')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="34" viewBox="0 0 45 34" fill="none">
                        <path
                            d="M6.75 14.1807C9.23203 14.1807 11.25 12.061 11.25 9.45378C11.25 6.84661 9.23203 4.72689 6.75 4.72689C4.26797 4.72689 2.25 6.84661 2.25 9.45378C2.25 12.061 4.26797 14.1807 6.75 14.1807ZM38.25 14.1807C40.732 14.1807 42.75 12.061 42.75 9.45378C42.75 6.84661 40.732 4.72689 38.25 4.72689C35.768 4.72689 33.75 6.84661 33.75 9.45378C33.75 12.061 35.768 14.1807 38.25 14.1807ZM40.5 16.5441H36C34.7625 16.5441 33.6445 17.0685 32.8289 17.9179C35.6625 19.5501 37.6734 22.497 38.1094 25.9979H42.75C43.9945 25.9979 45 24.9417 45 23.6345V21.271C45 18.6638 42.982 16.5441 40.5 16.5441ZM22.5 16.5441C26.8523 16.5441 30.375 12.8438 30.375 8.27206C30.375 3.70027 26.8523 0 22.5 0C18.1477 0 14.625 3.70027 14.625 8.27206C14.625 12.8438 18.1477 16.5441 22.5 16.5441ZM27.9 18.9076H27.3164C25.8539 19.6461 24.2297 20.0893 22.5 20.0893C20.7703 20.0893 19.1531 19.6461 17.6836 18.9076H17.1C12.6281 18.9076 9 22.7186 9 27.416V29.5431C9 31.5003 10.5117 33.0882 12.375 33.0882H32.625C34.4883 33.0882 36 31.5003 36 29.5431V27.416C36 22.7186 32.3719 18.9076 27.9 18.9076ZM12.1711 17.9179C11.3555 17.0685 10.2375 16.5441 9 16.5441H4.5C2.01797 16.5441 0 18.6638 0 21.271V23.6345C0 24.9417 1.00547 25.9979 2.25 25.9979H6.88359C7.32656 22.497 9.3375 19.5501 12.1711 17.9179Z"
                            fill="#A4AABD" />
    ...
    methods: {
        ...
        getUserRole() {
            GET(ENDPOINTS.GET_USER_BY_ID + this.userID, this.token)
                .then((response) => {   
                    if (response.data.data.role === 'superadmin') this.isAdmin = true
